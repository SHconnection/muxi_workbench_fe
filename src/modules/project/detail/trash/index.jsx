...
class ProjectTrash extends Component {
  ...
  confirmMoveFile(finalMoveFolderId) {
    ...
    if (currentFile) {
      ...
      const newNode = { folder: false, id: currentFile.id, name: currentFile.name}
      const newTree = FileTree.insertNode(newNode, finalMoveFolderId, fileTreeTemp)
      if (newTree) {
        ...
        ProjectService.updateProjectFileTree(
          ...
          .then(() => {
            FileService.putBackProjectTrash(pid, currentFile.id)
              .then(() => {
                this.hideAlert()
                this.getTrash()
              })
  ...
  render() {
    ...
    return (
      <div className="projectDetail-container">
        ...
        <div className="projectDetail-content">
          ...
          <div className="projectDetail-allFile-list">
            <div className="projectDetail-allFile-list-title">
              ...
              <div className="trash-filelist-deletetime">
                删除日期
              </div>
              <div className="trash-filelist-createtime">
                创建日期
              </div>
            </div>
            {fileList.map (el => (
        ...
        {
          showMoveAlert ? (
            <AlertMoveFile fileTree={fileTree} cancel={this.hideAlert} confirmMoveFile={this.confirmMoveFile} />
          ) : ""
        }

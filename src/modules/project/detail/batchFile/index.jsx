...
class BatchFile extends Component {
    ...
    FileTree.getFileTree(pid)
      .then(res => {
        ...
        FileService.getFileList(FileTree.findFileIdList(fileRootId, res))
          .then(res1 => {
            /* eslint-disable */
            res1.FileList.forEach(item => { item.checked = false })
            /* eslint-disable */
            this.setState({
              filesList: res1,
  ...
  confirmDeleteFile() {
    ...
    FileService.deleteFileFolder(0, deleteData)
      .then(res => {
        ProjectService.updateProjectFileTree(pid, JSON.stringify(fileTree))
          .then(() => {
            // 更新视图
            ...
            fileList.length ? (
              <div className="projectDetail-allFile-list">
                <div className="projectDetail-allFile-list-title">
                  ...
                  <div className="projectDetail-allFile-list-url">
                    路径
                  </div>
                </div>
